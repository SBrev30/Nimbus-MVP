/*
  ...
  This migration creates only the missing characters table and related tables.
  The chapters table already exists but with a different schema.
*/

-- Characters table (the main missing table)
