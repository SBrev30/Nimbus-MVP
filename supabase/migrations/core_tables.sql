/*
  # Fixed Core Tables Migration - Characters and Chapters
  ...
  2. Security
    ...
    - Add policies for proper access control with IF NOT EXISTS checks
...
-- Create triggers for updated_at with existence checks (if function exists)
DO $$
BEGIN
