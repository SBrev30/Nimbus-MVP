...
import { Layers, Search, Palette, ArrowRight, Users, Star, CheckCircle, Menu, X, Github, Twitter, Linkedin } from 'lucide-react';
...
const NimbusLogo = ({ className = "w-8 h-8", collapsed = false }: { className?: string; collapsed?: boolean }) => {
  if (collapsed) {
    return (
      <svg 
        version="1.1" 
