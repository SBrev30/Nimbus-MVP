...
const NimbusLogo = () => {
  return (
    <div className="flex items-center space-x-3">
	 ...
	 viewBox="0 0 107.5 112.6" style="enable-background:new 0 0 107.5 112.6;" xml:space="preserve">
<path d="M61.8,69.1c-4-3.4-9.2-8-14.7-12.9l0,0C33.8,44.4,18.9,31.5,18.6,31c-0.6-0.7-1.6-0.6-1.8-0.6c-0.1,0,0,0,0,0H4.5
...
<path d="M45.8,44c4,3.4,9.2,8,14.7,12.9l0,0C73.9,68.6,88.7,81.6,89,82c0.6,0.7,1.8,0.6,1.8,0.6h2.1h1.3h8.9c1.2,0,2.2-1,2.2-2.2
